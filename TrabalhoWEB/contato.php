...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="FrameWorks/font-awesome-4.7.0/css/font-awesome.css">
        <link rel="stylesheet" type="text/css" href="FrameWorks/bootstrap-3.3.7-dist/css/bootstrap.css">
        <script src="FrameWorks/validator.min.js"></script>
        <script type="text/javascript" src="JavaScript/formularioContato.js"></script>
        <link rel="stylesheet" type="text/css" href="CSS/estilo.css">
        <link rel="icon" type="image/png" sizes="96x96" href="Imagem/icone.png">
        <title>Contato</title>
    </head>
    <body>
        <div class="container">
